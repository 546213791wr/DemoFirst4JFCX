...
$(document).ready(function(){
    ...
    $("#addPicture").click(function () {
        ...
        var jsonData={"orgFid":orgFid,"orgName":orgName,"isNormalOrg":isNormalOrg,
            "userTypeId":userTypeId,"ageGroupId":ageGroupId,"type":type};
        loadPage(ctxPath + "/admin/pltresClassify/to-add-carousel",
                ctxPath + "/admin/pltresClassify/org-carousel-res?orgFid=" + orgFid + "&orgName=" + orgName + "&userTypeId=" + userTypeId+"&ageGroupId="+ageGroupId+"&type="+type,
               jsonData);
    })
    ...
    $("a[data-name='modifyCarousel']").on('click',function(){
        ...
        loadPage(ctxPath + "/admin/pltresClassify/to-update-carousel?id=" + id + "&orgName=" + orgName + "&fid=" + fid + "&isNormalOrg=" + isNormalOrg + "&userTypeId=" + userTypeId + "&ageGroupId=" + ageGroupId + "&type=" + type + "&carouselUrl=" + carouselUrl,
            ctxPath + "/admin/pltresClassify/org-carousel-res?orgFid=" + fid + "&orgName=" + orgName + "&userTypeId=" + userTypeId + "&ageGroupId=" + ageGroupId + "&type=" + type);
    });
