...
public class HttpConnectionUtil {
    ...
    public static String requestMethod(String requestType, String urlStr, String body) {
        ...
        try {
            ...
            // 设置内容类型
            httpURLConnection.setRequestProperty("Content-Type", CONTENT_TYPE_TEXT_HTML);
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        System.out.println(requestMethod(HTTP_GET, "http://ptdesyxx.jichu.chaoxing.com/api/sync/evaluation",""));
//        System.out.println(requestMethod(HTTP_GET, "http://ptdesyxx.jichu.chaoxing.com/api/sync/evaluation?fanyaUserId=47837921&resId=43&bookId=4567&isbn=&userPaperId=2064&isPassed=0&createTime=",""));
