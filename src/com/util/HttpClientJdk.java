...
public class HttpClientJdk {
	...
	public static void main(String[] args) throws Exception {
		String requestUrl = "http://api.basicedu.chaoxing.com/pcRead/41477844/getUserReadTimeInfo";
...
//		requestUrl = "http://localhost/api/user/130/order";
//		Map<String, File> fileMap = new HashMap<String, File>();
//		fileMap.put("image", new File("c:/1.jpg"));
//		Map<String, String> parameterMap = new HashMap<String, String>();
//		parameterMap.put("merchantId", "38");
//		parameterMap.put("price", "100");
//		parameterMap.put("balancePrice", "20");
//		parameterMap.put("description", "北京市240");
//		System.err.println(httpRequest(requestUrl, "POST", buildRequestBody(parameterMap)));
		System.out.println(httpRequest(requestUrl,"GET",""));
	}
...
//			conn.setRequestProperty("content-type", "application/x-www-form-urlencoded");
	...
	/* 构造请求体 */
	public static String buildRequestBody(Map<String, String> parameterMap) {
		StringBuffer stringBuffer = new StringBuffer();
		for (Map.Entry<String, String> entry : parameterMap.entrySet()) {
